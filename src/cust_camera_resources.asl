        ...
        Package()
        {
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    package() { "CLOCK", package() { "cam_cc_jpeg_clk",        1} },
                ...
                Package()
                {
                    ...
                    Package() { "PSTATE", 0, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 600000000, 3, } }, },
                    Package() { "PSTATE", 1, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 600000000, 3, } }, },
                    Package() { "PSTATE", 2, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 404000000, 3, } }, },
                    Package() { "PSTATE", 3, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 200000000, 3, } }, },
                },
            },
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    Package() { "PSTATE", 0, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 600000000, 3, } }, },
                    Package() { "PSTATE", 1, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 600000000, 3, } }, },
                    Package() { "PSTATE", 2, Package() { "CLOCK", Package() { "cam_cc_jpeg_clk", 3, 200000000, 3, } }, },
                },
            },
        },
        ...
        Package()
        {
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    package() { "CLOCK", package() { "cam_cc_csi0phytimer_clk",  8,  269330000,  3, }},
                    package() { "CLOCK", package() { "cam_cc_csiphy0_clk",       8,  384000000,  3, }},
                },
        ...
        Package()
        {
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    Package(){"PSTATE_ADJUST", Package () { 1, 10 }},
                    ...
                    package(){ "CLOCK", package(){ "cam_cc_ife_0_cphy_rx_clk",     8,     384000000,    3, } },
                    package(){ "CLOCK", package(){ "cam_cc_ife_0_csid_clk",        8,     384000000,    3, } },
                ...
                Package()
                {
                    ...
                    Package(){"PSTATE_ADJUST", Package () { 2, 29 }},
                    Package(){"PSTATE_ADJUST", Package () { 1, 29 }},
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    package() { "CLOCK", package(){ "cam_cc_ife_1_cphy_rx_clk",     8,     384000000,    3, } },
                    package() { "CLOCK", package(){ "cam_cc_ife_1_csid_clk",        8,     384000000,    3, } },
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    package(){ "CLOCK", package(){ "cam_cc_ife_lite_cphy_rx_clk",     8,     384000000,    3, } },
                    package(){ "CLOCK", package(){ "cam_cc_ife_lite_csid_clk",        8,     384000000,    3, } },
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    package() { "CLOCK", package() { "cam_cc_icp_clk",             1 } },
                    package() { "PSTATE_ADJUST", Package() { 0, 1 } },
           ...
           Package()
           {
                ...
                Package()
                {
                    ...
                    Package() { "FOOTSWITCH", Package() { "ipe_0_gdsc",       3 } },
                    ...
                    Package() { "FOOTSWITCH", Package() { "ipe_1_gdsc",       3 } },
               ...
               Package()
               {
                   ...
                   Package() { "FOOTSWITCH", Package() { "ipe_1_gdsc",      4 } },
                   ...
                   Package() { "FOOTSWITCH", Package() { "ipe_0_gdsc",      4 } },
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    package() { "CLOCK", package() { "cam_cc_bps_ahb_clk",      1 } },

                    package() { "CLOCK", package() { "cam_cc_bps_clk",          1          } },
                    package() { "PSTATE_ADJUST", Package() { 0, 2 } },

                    package() { "CLOCK", package() { "cam_cc_bps_areg_clk",      1 } },
                    package() { "CLOCK", package() { "cam_cc_bps_axi_clk",       1          } },

                    Package() { "FOOTSWITCH", Package() { "bps_gdsc",      3 } },
                ...
                Package()
                {
                    ...
                    Package() { "FOOTSWITCH", Package() { "bps_gdsc",      4 } },
            ...
            Package()
            {
                ...
                Package()
                {
                    ...
                    Package() { "CLOCK", Package(){ "cam_cc_fd_core_clk",          1 }},
                    package() { "PSTATE_ADJUST", Package() { 0, 2 } },
